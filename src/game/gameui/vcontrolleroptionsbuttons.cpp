...
{
	{ "+duck",					"#GameUI_Controller_Crouch" },
	{ "+jump",					"#GameUI_Controller_Jump" },
	{ "+use",					"#GameUI_Controller_Use" },
	{ "+attack",				"#GameUI_Controller_Attack" },
	{ "+attack2",				"#GameUI_Controller_Melee" },
	{ "+reload",				"#GameUI_Controller_Reload" },
	{ "lastinv",				"#GameUI_Controller_LastInv" },
	{ "+zoom",					"#GameUI_Controller_Zoom" },
	{ "+lookspin",				"#GameUI_Controller_Lookspin" },
	{ "vocalize smartlook",		"#GameUI_Controller_Vocalize" }
};
...
void ControllerOptionsButtons::Activate()
{
	...
	if ( pLabel )
	{
		wchar_t *pwcTemplate = g_pVGuiLocalize->Find("#GameUI_Controller_Buttons_Title");
