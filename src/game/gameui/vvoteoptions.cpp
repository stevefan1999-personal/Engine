...
BaseClass(parent, panelName)
{
	...
	SetTitle("#GameUI_VoteOptions", false);

	m_BtnChangeScenario = new Button(this, "BtnChangeScenario", "#GameUI_ChangeScenario", this, "ChangeScenario");
	m_BtnChangeDifficulty = new Button(this, "BtnChangeDifficulty", "#GameUI_ChangeDifficulty", this, "ChangeDifficulty");
	m_BtnRestartScenario = new Button(this, "BtnRestartScenario", "#GameUI_RestartScenario", this, "RestartScenario");
