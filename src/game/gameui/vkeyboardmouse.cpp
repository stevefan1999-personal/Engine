...
{
	if( Q_stricmp( "#GameUI_Controller_Edit_Keys_Buttons", command ) == 0 )
	{
...
{
	BaseClass::DrawDialogBackground( "#GameUI_KeyboardMouse", NULL, "#GameUI_Controller_Desc", NULL, NULL, true );
}
