...
{
	"#GameUI_Controller_Hold",
	"#GameUI_Controller_Toggle"
};
...
{
	"#GameUI_Controller_Normal",
	"#GameUI_Controller_Inverted"
};

const char *pszButtonSettingsDisplayName[4] =
{
	"#GameUI_Controller_Buttons_Config1",
	"#GameUI_Controller_Buttons_Config2",
	"#GameUI_Controller_Buttons_Config3",
	"#GameUI_Controller_Buttons_Config4"
};

const char *pszStickSettingsDisplayName[4] = 
{
	"#GameUI_Controller_Sticks_Default",
	"#GameUI_Controller_Sticks_Southpaw",
	"#GameUI_Controller_Sticks_Legacy",
	"#GameUI_Controller_Sticks_Legacy_Southpaw"
};
...
void ControllerOptions::Activate()
{
	...
	wchar_t *pwcTemplate = g_pVGuiLocalize->Find( "#GameUI_Controller_Title" );
	if ( pwcTemplate )
	{
...
void ControllerOptions::OnCommand(const char *command)
{
	...
	else if ( !Q_strcmp( command, "Defaults" ) )
	{
		...
		if ( confirmation )
		{
			...
			data.pWindowTitle = "#GameUI_Controller_Default";
			data.pMessageText =	"#GameUI_Controller_Default_Details";
...
{
	BaseClass::DrawDialogBackground( NULL, m_Title, "#GameUI_Controller_Desc", NULL );
}
