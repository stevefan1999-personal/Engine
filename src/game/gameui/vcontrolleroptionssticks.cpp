...
void ControllerOptionsSticks::Activate()
{
	...
	if ( pLabel )
	{
		wchar_t *pwcTemplate = g_pVGuiLocalize->Find("#GameUI_Controller_Sticks_Title");
...
void ControllerOptionsSticks::UpdateFooter()
{
	...
	if ( s_joy_legacy.IsValid() )
	{
		...
		{
			footer->SetButtonText( FB_YBUTTON, "#GameUI_LegacyOn" );
		}
		else
		{
			footer->SetButtonText( FB_YBUTTON, "#GameUI_LegacyOff" );
		}
	}
}
...
void ControllerOptionsSticks::UpdateHelpText()
{
	...
	{
		if( bUsingLegacy ) 
			SetHelpText( "#GameUI_Controller_Tooltip_Sticks_Legacy_Southpaw" );
		else
			SetHelpText( "#GameUI_Controller_Tooltip_Sticks_Southpaw" );
	}
	else
	{
		if( bUsingLegacy ) 
			SetHelpText( "#GameUI_Controller_Tooltip_Sticks_Legacy" );
		else
			SetHelpText( "#GameUI_Controller_Tooltip_Sticks_Default" );
	}
}
